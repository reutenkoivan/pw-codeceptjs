...
import type { codeceptjsFixtureTypes } from './types'
...
export class CodeceptFixture extends Driver {
  ...
  */
  ...
  amOnPage: codeceptjsFixtureTypes.amOnPage = async (url) => {
  ...
  waitForURL: codeceptjsFixtureTypes.waitForURL = async (urlPart) => {
    const page = await this.getPage()
  ...
  refreshPage: codeceptjsFixtureTypes.refreshPage = async () => {
    const page = await this.getPage()
  ...
  workWithTab: codeceptjsFixtureTypes.workWithTab = async (id) => {
  ...
  createTab: codeceptjsFixtureTypes.createTab = async () => {
  ...
  closeTab: codeceptjsFixtureTypes.closeTab = async (closeTabID) => {
    const pages = this.context.pages()
  ...
  click: codeceptjsFixtureTypes.click = async (locator, { createsNewPage, ...restOptions } = {}) => {
    const page = await this.getPage()
  ...
  waitForText: codeceptjsFixtureTypes.waitForText = async (text, { locator }) => {
    const page = await this.getPage()
  ...
  appendField: codeceptjsFixtureTypes.appendField = async (text, { locator }) => {
    const page = await this.getPage()
  ...
  clearField: codeceptjsFixtureTypes.clearField = async (locator) => {
    const page = await this.getPage()
  ...
  fillField: codeceptjsFixtureTypes.fillField = async (text, { locator }) => {
    const page = await this.getPage()
  ...
  attachFile: codeceptjsFixtureTypes.attachFile = async (locator, { filePath }) => {
    const page = await this.getPage()
  ...
  pressKey: codeceptjsFixtureTypes.pressKey = async (key) => {
    const page = await this.getPage()
  ...
  clearCookie: codeceptjsFixtureTypes.clearCookie = async (cookieNames) => {
    const page = await this.getPage()
